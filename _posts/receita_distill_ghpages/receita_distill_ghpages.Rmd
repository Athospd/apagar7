...
description: |
  Passo a passo de como iniciar um blog com distill no R.
author:
  - name: Athos Damiani
...
6. Rode `distill::create_blog(".", "Blog do Athos")` para criar seu blog.
7. *Commitar* e *pushar* para o github.
8. Ir para o link que o Github Pages mostrou na hora da configuração.
